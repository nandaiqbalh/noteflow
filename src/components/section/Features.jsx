  ...
  return (
    <section className="bg-primary-1500 overflow-hidden bg-[url('../src/assets/Noise.webp')] bg-repeat">
      <div className="text-primary-50 relative m-auto max-w-[90rem] px-24 py-32">
        <div className="bg-primary-1300 absolute top-[50%] left-[100%] h-[62.5rem] w-[62.5rem] -translate-x-1/2 -translate-y-1/2 rounded-full opacity-100 blur-[40rem]" />
        ...
        <div className="grid grid-cols-2 items-center mb-20 gap-x-16">
          <figure>
            <img className="max-h-[45rem]" src={SmartOrganization} alt="Smart Organization" />
          </figure>
        ...
        <div className="grid grid-cols-2 items-center mb-20 gap-x-16">
          ...
          <figure>
            <img className="max-h-[45rem]" src={ContextualReminders} alt="Contextual Reminders" />
          </figure>
        </div>
      </div>
    </section>
