...
const Testimonials = () => {
  ...
  return (
    <section className={`bg-gradient-to-top`}>
      <div
        className={`m-auto flex max-w-[90rem] flex-col items-center px-24 py-32 max-xl:px-16 max-xl:py-24 max-lg:px-8 max-md:px-6 max-sm:px-4 max-sm:py-12`}
      >
        <div className={`max-w-52rem mb-20 flex flex-col items-center gap-y-6 max-lg:mb-18 max-lg:gap-y-0`}>
          <p
            className={`text-primary-1300 bg-primary-50 primary-glow w-min rounded-full px-4 py-2 text-base/8 max-lg:mb-8`}
          >
            Testimonials
          </p>

          <h2
            className={`text-primary-50 text-center text-6xl/18 font-semibold tracking-tighter max-xl:text-5xl/16 max-lg:mb-4 max-lg:text-4xl/10 max-lg:tracking-tight max-sm:text-3xl/9 max-sm:tracking-tighter max-sm:px-4`}
          >
            What our AI-powered <br /> notetakers have to say
          </h2>

          <p
            className={`text-primary-100 px-28 text-center text-xl/loose font-light max-lg:text-lg/8 max-md:px-6 max-sm:px-4`}
          >
      ...
      <div className={`mb-20 grid grid-cols-3 gap-x-6 justify-self-center px-24 max-xl:px-16 max-xl:gap-x-4 max-lg:mb-18 max-lg:grid-cols-2 max-sm:grid-cols-1 max-sm:px-6`}>
        <TestimonialList
